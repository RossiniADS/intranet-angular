...
- Create Angular project with ng: `ng new intranet-angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`intranet-angular.client.esproj`).
